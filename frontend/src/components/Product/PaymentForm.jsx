        ...
        <div className={styles.shippingForm}>
          <div className={styles.customerData}>
            <div className={styles.dataHeader}>
              ...
              <label htmlFor="customerData"><input
                type="checkbox"
                id="customerData"
                name="customerData"
            ...
            {editingCustomerData && (
              <div className={`${styles.inputs} ${styles.visible}`}>
                ...
                <input type="text" id="cellAddress" name="cellAddress" placeholder="Domicilio Celular" />
                ...
                <input type="text" id="apartment" name="apartment" placeholder="Dpto" />
          ...
          <div className={styles.receiverData}>
            <div className={styles.dataHeader}>
              ...
              <label htmlFor="receiverData"> <input type="checkbox" id="receiverData" name="receiverData" checked={editingReceiverData} onChange={toggleReceiverData} />Recibe otra persona</label>
            ...
            {editingReceiverData && (
              <div className={`${styles.inputs} ${styles.visible}`}>
                <input type="text" id="receiverName" name="receiverName" placeholder="Nombre" />
                <input type="text" id="receiverLastName" name="receiverLastName" placeholder="Apellido" />
                <input type="text" id="receiverCell" name="receiverCell" placeholder="Celular/WhatsApp" />
                <input type="text" id="receiverStreet" name="receiverStreet" placeholder="Calle" />
                <input type="text" id="receiverFloor" name="receiverFloor" placeholder="Piso" />
                <input type="text" id="receiverApartment" name="receiverApartment" placeholder="Departamento" />
                <input type="text" id="receiverNeighborhood" name="receiverNeighborhood" placeholder="Barrio" />
              </div>
            )}
          </div>
